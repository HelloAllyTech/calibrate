...
- **Calibrate agent** — define your agent's system prompt and tools directly in the config file. Calibrate runs the evaluation using an LLM of your choice.
- **Agent connection** — point calibrate at your existing agent's HTTP endpoint. Calibrate sends test inputs to it and evaluates the responses. No need to redefine your agent.

---

## Calibrate agent

Refer to [this sample](https://github.com/ARTPARK-SAHAI-ORG/calibrate/tree/main/examples/llm/config-internal-agent.json) for a full template.
...
<AccordionGroup>
  <Accordion title="Calibrate agent example">
    See the [full file on GitHub](https://github.com/ARTPARK-SAHAI-ORG/calibrate/tree/main/examples/llm/config-internal-agent.json).
  ...
  <Accordion title="Agent connection example">
    See the [full file on GitHub](https://github.com/ARTPARK-SAHAI-ORG/calibrate/tree/main/examples/llm/config-external-agent.json).
...
1. **Config file** — path to your config file (with `agent_url` set)
