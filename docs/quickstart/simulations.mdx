...
<Frame>
  <img
    src="./images/sim_run_share.png"
    alt="Simulation run with Share button"
  />
</Frame>

This toggles the run to **Public** and generates a shareable link. Anyone with the link can view the overall metrics, per-conversation results, and transcripts without needing a Calibrate account. Click the **Public** button again to make the run private.
