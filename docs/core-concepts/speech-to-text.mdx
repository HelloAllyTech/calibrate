...
<Frame>
  <img src="/quickstart/images/stt_datasets_tab.png" alt="STT Datasets Tab" />
</Frame>
...
<Frame>
  <img src="/quickstart/images/stt_new_dataset_dialog.png" alt="New STT Dataset Dialog" />
</Frame>

You'll be taken to the dataset detail page where you can add samples in two ways:

<Frame>
  <img src="/quickstart/images/stt_dataset_detail.png" alt="STT Dataset Detail Page" />
</Frame>
...
<Note>
  Audio files for existing samples cannot be replaced — delete the sample and re-add it with the correct audio if needed.
</Note>
